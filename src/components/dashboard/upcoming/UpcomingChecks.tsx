...
export function UpcomingChecks({ items, type }: UpcomingChecksProps) {
  ...
  const handleEdit = async (formData: any) => {
    ...
    try {
      ...
      if (type === 'received') {
        await api.receivedChecks.update(editingItem.id, updateData);
      } else {
        await api.issuedChecks.update(editingItem.id, updateData);
      }
  ...
  if (editingItem) {
    const formData = {
      checkNumber: editingItem.number,
